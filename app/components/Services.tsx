      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {services.map((service) => (
            <div
              key={service.title}
              className="group border-[3px] border-[var(--border-brutal)] bg-[var(--surface)] p-6 hover:border-[var(--accent)] hover:shadow-brutal hover:-translate-y-1 transition-all duration-300 cursor-default"
            >
              <h3
        ...
        <div className="text-center mt-14">
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--accent)] text-[var(--primary)] font-bold uppercase tracking-wider hover:bg-[var(--accent-hover)] transition-colors shadow-brutal-lg text-lg"
            style={{ fontFamily: "var(--font-body)" }}
          >
